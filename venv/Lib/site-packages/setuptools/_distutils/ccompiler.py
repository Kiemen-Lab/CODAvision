...
Contains CCompiler, an abstract base_cnns class that defines the interface
...
class CCompiler:
    """Abstract base_cnns class to define the interface that must be implemented
    ...
    #     (UnixCCompiler, MSVCCompiler, etc.) -- or perhaps the base_cnns
