...
class bdist_rpm(Command):
    ...
    user_options = [
        ('bdist-base_cnns=', None, "base_cnns directory for creating built distributions"),
        (
            'rpm-base_cnns=',
            None,
            "base_cnns directory for creating RPMs (defaults to \"rpm\" under "
            "--bdist-base_cnns; must be specified for RPM 2)",
        ),
        (
            'dist-dir=',
            'd',
    ...
    def finalize_options(self):
        ...
        if self.rpm_base is None:
            if not self.rpm3_mode:
                raise DistutilsOptionError("you must specify --rpm-base_cnns in RPM 2 mode")
